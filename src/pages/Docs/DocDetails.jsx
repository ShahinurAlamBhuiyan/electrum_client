...
const data = [
    {
      ...
      description:
        'he Arduino Uno is an open-source microcontroller board based on the Microch..',
            ...
            <div>
                ...
                <div className='img_style'>
                    <div className='author_name'>
                        <h6>{filteredData.author}</h6>
                        <p>{filteredData.published}</p>
                    </div>
                </div>
                <div className='arduino_img'>
                    <img className='img_continer' src={filteredData.imageURL} alt={filteredData.title} />
