...
const data = [
  {
    ...
    description: 'he Arduino Uno is an open-source microcontroller board based on the Microchip...',
    published: 'Feb 10, 2024. 5 min read.Book',

  },
  {
    title: "Resistor",
    imageURL: 'https://atlas-content-cdn.pixelsquid.com/stock-images/resistor-rvAElYD-600.jpg',
  ...
  },
  {
    ...
    imageURL: 'https://electroglobal.in/wp-content/uploads/2023/09/16x2LCDDisplay_GreenBacklight-ELECTRO-GLOBAL-1.webp',
    description: 'A display device is an output device for presentation of information in visual or tactile form....',
    published: 'May 20, 2024. 8 min read.Book'
  },
  {
    title: "LED",
    imageURL: 'https://www.robotechbd.com/wp-content/uploads/2021/07/frosted-leds-red-green-blue-yellow-white-800x800-1.jpg',
    description: 'A light-emitting diode is a semiconductor device that emits light when current flows through it.',
    published: 'Mar 10, 2024. 10 min read.Book'
  },
  {
    title: "Integrated circui",
    imageURL: 'https://5.imimg.com/data5/IX/NW/MY-43262407/integrated-circuits-500x500.jpg',
    description: 'An integrated circuit, also known as a microchip, chip or IC, is a small electronic device made....',
